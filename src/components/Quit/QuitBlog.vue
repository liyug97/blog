<template>
  <div class="quitblog">
    ...
    <div class="quit">
      <h2>你好 <span>{{name}}</span></h2>
      <el-button type="primary" round @click="quit">注销登录</el-button>
    </div>
  </div>
</template>
<script>
...
.r160 {
  -webkit-transform: rotate(160deg);/*兼容谷歌*/
  -moz-transform: rotate(160deg);/*兼容火狐*/
  -ms-transform: rotate(160deg);/*兼容ie*/
  -o-transform: rotate(160deg);/*兼容Opera*/
...
.belly {
  ...
  background: -webkit-gradient(
    ...
    left top,
    from(#07beea),
    color-stop(0.5, #0073b3),
    color-stop(0.75, #00b0e0),
    to(#0096be)
  );
